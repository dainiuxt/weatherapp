...
async function displayData() {
    ...
    function forecastWeather() {
        ...
        for (var i = 1; i < 40; i += 4) {
            ...
            console.log(_typeof(newDateElements.year) + '-' + _typeof(newDateElements.month) + '-' + _typeof(newDateElements.day) + ' ' + _typeof(newDateElements.hour) + ':' + _typeof(newDateElements.minute));
