...
function displayData(data) {
    ...
    for (var i = 1; i < 40; i++) {
        ...
        var cityDate = convertEpochToSpecificTimezone(cityTime, data.city.timezone / 3600);
        var insertDate = cityDate;
        ...
        var windDirectionForecast = arr[windSectorForecast % 16];
