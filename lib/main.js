...
async function displayData() {
    ...
    function currentWeather() {
        ...
        var TNtextContent = newDateElements.year + '-' + newDateElements.month + '-' + newDateElements.day + ', ' + newDateElements.weekday + ' ' + newDateElements.hour + ':' + newDateElements.minute;
        // timeNow.textContent = TNtextContent;
        console.log(typeof TNtextContent === 'undefined' ? 'undefined' : _typeof(TNtextContent));
    ...
    function forecastWeather() {
        ...
        for (var i = 1; i < 40; i += 4) {
            ...
            var insertDate = dayjs(cityTime).locale('' + language).format('MMM DD HH:mm');
            var insertWeekday = dayjs(cityTime).locale('' + language).format('ddd');
